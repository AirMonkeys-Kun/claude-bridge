...
echo {"v":3,"state":"idle"} > "%BASE%\network_bridge\queue.txt"
...
start /B powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%BASE%\network_bridge\worker.ps1" -WorkerDir "%BASE%\network_bridge"
