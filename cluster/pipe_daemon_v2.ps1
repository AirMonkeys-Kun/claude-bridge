...
while ($true) {
    ...
    Remove-Item $masterQueueFile -Force -ErrorAction SilentlyContinue`r`n    $batchResultUniqueFile = Join-Path $clusterDir (".pipe_result_" + $batchCount + ".json")`r`n    Log "Unique result: $batchResultUniqueFile"
